...
8. 在设置->chat中可以开启双击编辑消息以及显示聊天token计数，在developer中开启llm服务可以关闭lm studio应用程序但是照常使用
#### 性能示例
...
电脑：4060 8G显存 32G运行内存 i7（应该没人比我的更低了我的电脑都三四年了）

测试时后台开了二十多个程序（包括浏览器、火眼等）进行压力测试（其实是我懒得关）

模型qwen3.6-35b-a3b-uncensored-hauhaucs-aggressive

测试效果为21.75token/s

### 我又写了一篇文章，当然，这篇文章没有过时，只是有些新技术没有提到